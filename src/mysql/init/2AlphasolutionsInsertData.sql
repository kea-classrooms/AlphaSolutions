...
INSERT INTO tasks(taskName, taskDescription , cost, totalEstimatedTime, project_ID) VALUE ("Deadlines", "Tjek at man kan lave deadlines",1, 60, 1);
INSERT INTO tasks(taskName, taskDescription , cost, totalEstimatedTime, project_ID) VALUE ("Lav kaffe", "100% den vigtigeste opgave",69, 420, 2);
INSERT INTO tasks(taskName, taskDescription , cost, totalEstimatedTime, project_ID) VALUE ("Husk at holde pause", "Optimer arbejdstid ved at holde pause <3",1200000, 56532, 1);
